      ...
      return(
            <div className="landing-container">
                ...
                <div className="landing-content row-1">
                    ...
                    <LandingCardText class="right inlineText" title="Our Mission Statement" text="We are SchoolMe, a non-profit web application for storing and sharing school related data between School Administrators, Social Workers, and Education Board Members. We want to create a platform to help board members connect with students in need across our organization. Board members are able to assist in paying the school dues of students who cannot pay themselves." />
                </div>
                <div className="landing-content row-2">
                    <LandingCardText class="left inlineText" title="About Us" text="We are a team of developers working together on this project while taking instruction with Lambda School. This app is to be our Capstone Project to start us off. We want to create an app that will be useful to the people who really need it. " />
                    <LandingCardImg  class="right inlineImg class" />
                </div>
                <div className="landing-content row-3">
                    <LandingCardBtn class="center inlineText" title="Would you like to start using SchoolMe" text="$60USD/Year" btnText="Subscribe Now!" btnHandler={null} />
                </div>
